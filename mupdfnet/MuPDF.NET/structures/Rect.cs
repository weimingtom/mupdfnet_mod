...
namespace MuPDF.NET
{
    public class Rect
    {
        ...
        public int Length { get {return Length_;} set {Length_ = value;} }// = 4;
        ...
        override
        public string ToString() { return "Rect(" + X0 + ", " + Y0 + ", " + X1 + ", " + Y1 + ")"; }
        ...
        public float GetArea(string unit = null)
        {
            ...
            if (!string.IsNullOrEmpty(unit))
                unit_ = unit;
            Dictionary<string, ValueTuple<float, float>> u = new Dictionary<string, ValueTuple<float, float>>
            {
                { "px", new ValueTuple<float, float>(1, 1) },
                { "in", new ValueTuple<float, float>(1.0f, 72.0f) },
                { "cm", new ValueTuple<float, float>(2.54f, 72.0f) },
                { "mm", new ValueTuple<float, float>(25.4f, 72.0f) }
            };
