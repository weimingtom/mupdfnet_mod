...
namespace MuPDF.NET
{
    public class Outline
    {
        ...
        public LinkDest Dest
        {
            get
            {
                return new LinkDest(this, new ValueTuple<List<int>, float, float>(null, 0, 0), null);
            }
        }
        ...
        {
            return new LinkDest(this, new ValueTuple<List<int>, float, float>(null, 0, 0), new Document(doc));
        }
