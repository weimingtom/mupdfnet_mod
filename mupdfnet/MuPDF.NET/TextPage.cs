...
namespace MuPDF.NET
{
    public class TextPage
    {
                    ...
                    for (fz_stext_char ch = line.first_char; ch != null; ch = ch.next)
                    {
                        ...
                        while (true)
                        {
                            ...
                            if (inside != 0)
                            {
                                ...
                                {
                                    inside = 0;
                                    ValueTuple<int, int> _ = stPage.FindString(
        ...
        public ValueTuple<int, int> FindString(string s, string needle)
        {
            for (int index = 0; index < s.Length - needle.Length; index++)
            {
                ...
                if (end != -1)
                {
                    ...
                    return new ValueTuple<int, int>(index, end);
                }
            }
    ...
    public class MuPDFCharStyle
    {
        ...
        public MuPDFCharStyle(Dictionary<string, object/*dynamic*/> rhs)
        {
        	Size = (float)rhs["Size"];
        	Flags = (float)rhs["Flags"];
        	Font = (string)rhs["Font"];
        	Color = (int)rhs["Color"];
        	Asc = (float)rhs["Asc"];
        	Desc = (float)rhs["Desc"];
        }
