...
namespace MuPDF.NET
{
    public class Annot
    {
        ...
        public ValueTuple<PdfLineEnding, PdfLineEnding> LineEnds
        {
            get
            {
                PdfAnnot annot = _nativeAnnotion;
                if (annot.pdf_annot_has_line_ending_styles() == 0)
                    return new ValueTuple<PdfLineEnding, PdfLineEnding>(0, 0);
                ...
                return new ValueTuple<PdfLineEnding, PdfLineEnding>(lstart, lend);
            }
        }
        ...
        public ValueTuple<float, float, float, float> RectDelta
        {
            get
            {
                ...
                {
                    return new ValueTuple<float, float, float, float>(
                    ...
                    return new ValueTuple<float, float, float, float>(0, 0, 0, 0);
            }
        }
        ...
        public object/*dynamic*/ Vertices
        {
            get
            {
                PdfAnnot annot = _nativeAnnotion;
        ...
        public static string UnicodeFromStr(object s)
        {
            ...
            if (s is string || s == null)
                return "";
            if (s is byte[])
            	ret = Encoding.UTF8.GetString((byte[])s);
            return ret;
        }

        public ValueTuple<PdfAnnotType, string, string> Type
        {
            get
            {
                if (this == null)
                    return new ValueTuple<PdfAnnotType, string, string>(PdfAnnotType.PDF_ANNOT_UNKNOWN, null, null);
                ...
                if (obj == null || obj.pdf_is_name() != 0)
                    return new ValueTuple<PdfAnnotType, string, string>((PdfAnnotType)t, c, null);
                string it = obj.pdf_to_name();

                return new ValueTuple<PdfAnnotType, string, string>((PdfAnnotType)t, c, it);
            }
        }
        ...
        public AnnotValues GetRedactValues()
        {
            ...
            ValueTuple<List<float>, string, float> _ = ParseData(this);
            tColor = _.Item1;
            values.FontName = _.Item2;
            values.FontSize = _.Item3;
        ...
        public static ValueTuple<List<float>, string, float> ParseData(Annot annot)
        {
            ...
            {
                return new ValueTuple<List<float>, string, float>(new List<float>(), "", 0.0f);
            }
            ...
            return new ValueTuple<List<float>, string, float>(col, font, fsize);
        }
        ...
        {
             ValueTuple<PdfAnnotType, string, string> _ = this.Type;
             PdfAnnotType atype = _.Item1;
             string atname = _.Item2;
        ...
        )
        {
            ...
            {
                ValueTuple<List<float>, string, float> _ = ParseData(this);
				List<float> tcol = _.Item1;
				string fname = _.Item2;
				float fsize = _.Item3;
                ...
                )
                {
                    ...
                    apUpdated = true;
                    List<Point> points = (List<Point>)Vertices;
                    Point p1 = null;
                    Point p2 = null;
        ...
        )
        {
            ...
            Point,
            float,
            String3> _ = le_annot_parms(annot, p1, p2, fillColor);
            Matrix m = _.Item1;
            Matrix im = _.Item2;
            Point L = _.Item3;
            Point R = _.Item4;
            float w = _.Item5;
            string scol = _.Item6.a;
            string fcol = _.Item6.b;
            string opacity = _.Item6.c;
        ...
        public class String3 
        {
        	...
        	public string b;
        	public string c;
        	public String3(string a, string b, string c)
        	{
        		this.a = a;
        		this.b = b;
        		this.c = c;
        ...
        internal static ValueTuple<
            Matrix,
            Matrix,
            Point,
            Point,
            float,
            String3> le_annot_parms(Annot annot, Point p1, Point p2, float[] fillColor)
        {
            ...
            return new ValueTuple<
			            ...
			            Point,
			            float,
			            String3>(m, im, L, R, w, new String3(scol, fcol, opacity));
        }
        ...
        public static byte[] ColorString(object/*dynamic*/ cs, string code)
        {
            UTF8Encoding utf8 = new UTF8Encoding();
            if (cs is List<float>)
            	cs = ((List<float>)cs).ToArray();
            string cc = ColorCode((float[])cs, code);
            if (cc == "")
