...
namespace MuPDF.NET
{
    public class LinkDest
    {
        ...
        public Point TopLeft { get { return TopLeft_;} set { TopLeft_ = value;} }
        private Point TopLeft_ = new Point(0, 0);

        public string NewWindow { get; set; }

        public Point BottomRight { get { return BottomRight_;} set { BottomRight_ = value;} }
        private Point BottomRight_ = new Point(0, 0);
        ...
        public LinkDest(object/*dynamic*/ obj, ValueTuple<List<int>, float, float> rlink, Document document = null)
        {
        	bool isExt = ((Link)obj).IsExternal;
            bool isInt = !isExt;
            this.Dest = "";
            this.FileSpec = "";
            this.Flags = 0;
