    ...
    public class Font
    {
        ...
        )
        {
            ...
            foreach (char ch in text)
            {
                ...
                {
                    ValueTuple<int, FzFont> _ = _nativeFont.fz_encode_character_with_fallback(
                        c,
                        script,
                        (int)lang
                    );
        ...
        )
        {
            ...
            {
                ValueTuple<int, FzFont> _ = _nativeFont.fz_encode_character_with_fallback(chr, script, (int)lang);
            	gid = _.Item1;
            	font = _.Item2;
            }
        ...
        )
        {
            ...
            foreach (char ch in text)
            {
                ...
                {
                    ValueTuple<int, FzFont> _ = thisfont.fz_encode_character_with_fallback(c, script, lang);
                	gid = _.Item1;
                	font = _.Item2;
                }
